...
void caseThree()
{
  ...
  catch (llist::Underflow){cout << "cant delete front" << endl;}
}   //end of case 3
...
void caseFour()
{
  ...
  catch (llist::OutOfRange){cout << " cant delete out of range" << endl;}
  //    2.delete rear . error (underflow)
  cout << 2 << endl;
  try {L4.deleteRear(x);}
  catch (llist::Underflow){cout << "cant delete list is empty" << endl;}
} // end of case 4
